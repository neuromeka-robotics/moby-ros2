...
class IndyMaster:
    ...
    def update_teleoperation_traj(self, target_pos, time_const):
        return self.stub.UpdateTeleoperationTraj(TaskFloat(task_float=[target_pos[0], target_pos[1], target_pos[2], target_pos[3],
                                                                      target_pos[4], target_pos[5], time_const]))
    ...
    def switch_csp_mode(self, csp_mode):
        return self.stub.ChangeToCSPMode(BoolVal(val=csp_mode))   
